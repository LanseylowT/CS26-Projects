...
public class ModerScrollBar extends BasicScrollBarUI {
    ...
    protected Dimension getMinimumThumbSize() {
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) return new Dimension(0, THUMB_SIZE);
        else return new Dimension(THUMB_SIZE, 0);
    }
